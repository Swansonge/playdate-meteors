--  SceneManager class from squidgod https://github.com/SquidGodDev/escape-from-complex-32/blob/main/source/scripts/sceneManager.lua. 
-- It's a sprite that draws the
